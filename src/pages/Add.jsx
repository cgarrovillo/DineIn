...
export default function Add() {
  ...
  return (
    <section className="center fullpage" id="add">
      <h2>Add a Menu</h2>
      <p>
        Found a restaurant with no online prices? Add them below and help others
        make informed decisions.
      </p>
      <p>To start, enter the name of the restaurant you want to add below</p>
      <form name="form" id="form" onSubmit={handleSubmit} ref={form}>
        ...
        <input
          ...
          required
        />
        <label htmlFor="file" className="clr--primary">
          {status}
        </label>
      </form>
    </section>
